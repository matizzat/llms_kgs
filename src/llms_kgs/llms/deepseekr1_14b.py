from llms_kgs.llms.llm_invocation_data import LLMInvocationData
from llms_kgs.llms.llm_protocol import LLMProtocol
...
class DeepSeekR1_14B(LLMProtocol):
